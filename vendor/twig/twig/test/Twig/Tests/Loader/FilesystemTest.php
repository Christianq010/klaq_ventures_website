...
class Twig_Tests_Loader_FilesystemTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testPaths()
    {
        ...
        $this->assertEquals("path (final)\n", $loader->getSource('home.twig'));
        $this->assertEquals("path (final)\n", $loader->getSource('@__main__/home.twig'));
        $this->assertEquals("named path (final)\n", $loader->getSource('@named/home.twig'));
    }
    ...
    public function testFindTemplateWithCache()
    {
        ...
        // prime the cache for home.twig in the named namespace
        $namedSource = $loader->getSource('@named/home.twig');
        $this->assertEquals("named path\n", $namedSource);

        // get home.twig from the main namespace
